...
public class DoWhile implements Instruction
{
    ...
    public DoWhile(Expression condition, LinkedList<Instruction> list, int line, int column)
    {
    ...
    public Object execute(Enviroment env)
    {
        ...
        {
            Error_ error = new Error_(line, column, "De ejecucion", "Excepcion no controlada en sentencia 'DoWhile'.");
